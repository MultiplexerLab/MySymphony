...
import sym.appstore.Activity.ContentDescriptionActivity.ShikkhaSohaYikaDescriptionActivity;
...
public class RecyclerAdapterForShikkhaSohayika extends RecyclerView.Adapter<RecyclerAdapterForShikkhaSohayika.RecyclerViewHolder> {
    ...
    Activity activity;
    public RecyclerAdapterForShikkhaSohayika(Activity activity,ArrayList<Porashuna> shikkhaSohaYikaArrayList)
    {
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        Glide.with(activity)
                .load(shikkhaSohaYikaArrayList.get(position).getThumbnailImgUrl())
    ...
    public  static  class  RecyclerViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public RecyclerViewHolder(View view, final Activity activity, final ArrayList<Porashuna> shikkhaSohaYikaArrayList)
        {
            super(view);
