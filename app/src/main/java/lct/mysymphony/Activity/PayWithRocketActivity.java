...
public class PayWithRocketActivity extends AppCompatActivity implements DownloadImage.AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (dataBaseData == null) Log.d("dataBaseData", "null");
    ...
    private void sendRocketVerificationToServer() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Endpoints.GET_REFEREL_CODE_URL, new Response.Listener<String>() {
            @Override
...
//        HideProgressDialog();
 ...
 /*   public void ShowProgressDialog() {
        dialogBuilder = new AlertDialog.Builder(PayWithRocketActivity.this);
