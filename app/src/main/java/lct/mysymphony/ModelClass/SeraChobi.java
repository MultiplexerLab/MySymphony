...
public class SeraChobi implements Serializable {
    ...
    public SeraChobi(String image_url, String description, String contentType, String contentTitle, String contentCat,int contentId,String contentDesc,int contentPrice) {
