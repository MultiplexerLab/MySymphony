...
public class UniversalVideoView extends SurfaceView
    ...
    public UniversalVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, lct.mysymphony.R.styleable.UniversalVideoView,0,0);
        mFitXY = a.getBoolean(lct.mysymphony.R.styleable.UniversalVideoView_uvv_fitXY, false);
        mAutoRotation = a.getBoolean(lct.mysymphony.R.styleable.UniversalVideoView_uvv_autoRotation, false);
        a.recycle();
        initVideoView();
    }
