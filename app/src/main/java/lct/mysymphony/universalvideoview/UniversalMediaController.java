...
//    private boolean mFullscreenEnabled = false;
    ...
    public UniversalMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, lct.mysymphony.R.styleable.UniversalMediaController);
        mScalable = a.getBoolean(lct.mysymphony.R.styleable.UniversalMediaController_uvv_scalable, false);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(lct.mysymphony.R.layout.uvv_player_controller, this);
    ...
    private void initControllerView(View v) {
        mTitleLayout = v.findViewById(lct.mysymphony.R.id.title_part);
        mControlLayout = v.findViewById(lct.mysymphony.R.id.control_layout);
        loadingLayout = (ViewGroup) v.findViewById(lct.mysymphony.R.id.loading_layout);
        errorLayout = (ViewGroup) v.findViewById(lct.mysymphony.R.id.error_layout);
        mTurnButton = (ImageButton) v.findViewById(lct.mysymphony.R.id.turn_button);
        mScaleButton = (ImageButton) v.findViewById(lct.mysymphony.R.id.scale_button);
        mCenterPlayButton = v.findViewById(lct.mysymphony.R.id.center_play_btn);
        mBackButton = v.findViewById(lct.mysymphony.R.id.back_btn);
        ...
        View bar = v.findViewById(lct.mysymphony.R.id.seekbar);
        ...
        mEndTime = (TextView) v.findViewById(lct.mysymphony.R.id.duration);
        mCurrentTime = (TextView) v.findViewById(lct.mysymphony.R.id.has_played);
        mTitle = (TextView) v.findViewById(lct.mysymphony.R.id.title);
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case SHOW_LOADING: //3
                    show();
                    showCenterView(lct.mysymphony.R.id.loading_layout);
                    break;
                case SHOW_COMPLETE: //7
                    showCenterView(lct.mysymphony.R.id.center_play_btn);
                    break;
                case SHOW_ERROR: //5
                    show();
                    showCenterView(lct.mysymphony.R.id.error_layout);
                    break;
                case HIDE_LOADING: //4
                case HIDE_ERROR: //6
    ...
    private void showCenterView(int resId) {
        if (resId == lct.mysymphony.R.id.loading_layout) {
        ...
        } else if (resId == lct.mysymphony.R.id.center_play_btn) {
            if (mCenterPlayButton.getVisibility() != VISIBLE) {
        ...
        } else if (resId == lct.mysymphony.R.id.error_layout) {
            if (errorLayout.getVisibility() != VISIBLE) {
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(lct.mysymphony.R.drawable.uvv_player_player_btn);
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(lct.mysymphony.R.drawable.uvv_stop_btn);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(lct.mysymphony.R.drawable.uvv_player_player_btn);
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(lct.mysymphony.R.drawable.uvv_star_zoom_in);
        } else {
            mScaleButton.setImageResource(lct.mysymphony.R.drawable.uvv_player_scale_btn);
        }
    }
