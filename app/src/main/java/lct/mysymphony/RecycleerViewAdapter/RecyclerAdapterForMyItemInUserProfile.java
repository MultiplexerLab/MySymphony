...
public class RecyclerAdapterForMyItemInUserProfile extends RecyclerView.Adapter<RecyclerAdapterForMyItemInUserProfile.RecyclerViewHolder> {
   ...
   /// private int[] images = {R.drawable.japito_jibon_1, R.drawable.japito_jibon_2};
    ...
    public RecyclerAdapterForMyItemInUserProfile(Activity activity, ArrayList<GoromKhobor> goromKhoborArrayList) {
