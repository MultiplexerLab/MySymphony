...
package harmony.app.UniversalVideoview;
...
public class UniversalMediaController extends FrameLayout {
    ...
    public UniversalMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, harmony.app.R.styleable.UniversalMediaController);
        mScalable = a.getBoolean(harmony.app.R.styleable.UniversalMediaController_uvv_scalable, false);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(harmony.app.R.layout.uvv_player_controller, this);
    ...
    private void initControllerView(View v) {
        mTitleLayout = v.findViewById(harmony.app.R.id.title_part);
        mControlLayout = v.findViewById(harmony.app.R.id.control_layout);
        loadingLayout = (ViewGroup) v.findViewById(harmony.app.R.id.loading_layout);
        errorLayout = (ViewGroup) v.findViewById(harmony.app.R.id.error_layout);
        mTurnButton = (ImageButton) v.findViewById(harmony.app.R.id.turn_button);
        mScaleButton = (ImageButton) v.findViewById(harmony.app.R.id.scale_button);
        mCenterPlayButton = v.findViewById(harmony.app.R.id.center_play_btn);
        mBackButton = v.findViewById(harmony.app.R.id.back_btn);
        ...
        View bar = v.findViewById(harmony.app.R.id.seekbar);
        ...
        mEndTime = (TextView) v.findViewById(harmony.app.R.id.duration);
        mCurrentTime = (TextView) v.findViewById(harmony.app.R.id.has_played);
        mTitle = (TextView) v.findViewById(harmony.app.R.id.title);
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case SHOW_LOADING: //3
                    show();
                    showCenterView(harmony.app.R.id.loading_layout);
                    break;
                case SHOW_COMPLETE: //7
                    showCenterView(harmony.app.R.id.center_play_btn);
                    break;
                case SHOW_ERROR: //5
                    show();
                    showCenterView(harmony.app.R.id.error_layout);
                    break;
                case HIDE_LOADING: //4
                case HIDE_ERROR: //6
    ...
    private void showCenterView(int resId) {
        if (resId == harmony.app.R.id.loading_layout) {
        ...
        } else if (resId == harmony.app.R.id.center_play_btn) {
            if (mCenterPlayButton.getVisibility() != VISIBLE) {
        ...
        } else if (resId == harmony.app.R.id.error_layout) {
            if (errorLayout.getVisibility() != VISIBLE) {
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(harmony.app.R.drawable.uvv_player_player_btn);
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(harmony.app.R.drawable.uvv_stop_btn);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(harmony.app.R.drawable.uvv_player_player_btn);
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(harmony.app.R.drawable.uvv_star_zoom_in);
        } else {
            mScaleButton.setImageResource(harmony.app.R.drawable.uvv_player_scale_btn);
        }
    }
