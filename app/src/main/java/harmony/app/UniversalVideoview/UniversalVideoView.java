...
public class UniversalVideoView extends SurfaceView
    ...
    public UniversalVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, harmony.app.R.styleable.UniversalVideoView, 0, 0);
        mFitXY = a.getBoolean(harmony.app.R.styleable.UniversalVideoView_uvv_fitXY, false);
        mAutoRotation = a.getBoolean(harmony.app.R.styleable.UniversalVideoView_uvv_autoRotation, false);
        a.recycle();
        initVideoView();
    }
